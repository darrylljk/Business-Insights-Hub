...
## Project Overview
### Motivation
This is a personal project of mine centering around data analysis and visualization with Power BI and Power Query. I built the Business Insights Hub as a demo to showcase how real-world companies can leverage data-driven insights in an all-in-one platform to improve business performance, optimize decision-making, and identify growth opportunities across key areas such as sales, customer behavior, and product trends.
